...
begin
	case(lut_index)			  
	    ...
	    10'd227: lut_data <= {8'h78 , 24'h380c03};// HTS            //Total horizontal size 
	    10'd228: lut_data <= {8'h78 , 24'h380d20};// HTS
	    10'd229: lut_data <= {8'h78 , 24'h380e02};// VTS            //total vertical size
	    10'd230: lut_data <= {8'h78 , 24'h380f0d};// VTS 
